...
$query = mysqli_query($connections, "INSERT INTO mytbl (name, address, email, password, account_type,section,contact) VALUES ('$name', '$address', '$email', '$cpassword','2','$section', '$contact')");
